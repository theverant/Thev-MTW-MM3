...
#define STRING_VERSION_CONFIG_H "EmEmThree on " __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "ThevHumped™" // Who made the changes.
...
#define X_MAX_POS 263 // 230 // THev MTW stock dual extruder
#define X_MIN_POS 0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,800,99}  // default steps per unit for Ultimaker
...
// For the other hotends it is their distance from the extruder 0 hotend.
 #define EXTRUDER_OFFSET_X {0.0, -33.00} // MTW Stock 2 extruder setup
...
#define ThevMENU // adds a custom menu to the LCD.
#ifdef ThevMENU
#define FAN_MAX 255
#endif
#define FANRAMP
#ifdef FANRAMP
#define FANRAMP_STEP 6 // increment to change fan speed per FANRAMP_TIME
#define FANRAMP_TIME 1500 // milliseconds
#endif
<----- For future implementation
*/
